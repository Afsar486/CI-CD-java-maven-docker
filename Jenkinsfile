node {
    ...
    stage('Deploy Docker Image and login'){
      ...
      echo "Docker Image Tag Name: ${dockerImageTag}"
        ...
        sh "docker images"
        sh "docker login -u afsar486 -p $DOCKER_PWD"// put PWD
	...
	//sh "read imageid"
	   sh "docker tag ci-cd-pipelineproject   afsar486/myapplication" //must change the name and tag no
       sh "docker push   afsar486/myapplication"
  }
}
